...
<body>
    ...
    <div class="chartA">
        ...
        <div class="chart bg-wpink"><button type="button" onclick="location.href='http://localhost:5173/scan/camera/TF2/division/effect'" class="a bg-pink">효과</button></div>
        <div class="chart bg-wpink"><button type="button" onclick="location.href='http://localhost:5173/scan/camera/TF2/division/side-effect'" class="a bg-wpink">부작용</button></div>
        <div class="chart bg-wpink"><a href="/scan/camera/TF2/division/else" class="white-link">기타</a></div></div>
    <div class="inf m50">약 이름 : </div>
    <div class="inf m20 ">효과 :<br></div>
