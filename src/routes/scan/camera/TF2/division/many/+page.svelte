...
<body>
    ...
    <div class="chartA">
        ...
        <div class="chart bg-wpink"><button type="button" onclick="location.href='http://localhost:5173/scan/camera/TF2/division/many'" class="a bg-pink">복용량</button></div>
